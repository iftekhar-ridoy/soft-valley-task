        ...
        <section className='mt-20 lg:mt-[125px] px-5 lg:px-0 mb-20 w-full max-w-7xl mx-auto'>
            <div className='z-30'>
                ...
                <h1 className='font-["Manrope"] font-extrabold text-2xl lg:text-[40px] text-[#0C0047] lg:leading-[48px] tracking-[0.005em] mb-2'>We have the best team <br />
                    and best process</h1>
                <p className='text-[#64607D] text-xs md:text-[15px] font-medium font-["Manrope"] lg:leading-7 max-w-xs mb-5'>Yet bed any for travelling assistance indulgence unpleasing. Not thoughts all exercise blessing. Indulgence way everything joy.</p>
            ...
            <div className='-ml-5 mt-[-50px] md:mt-[-120px] lg:mt-[-180px] xl:mt-[-220px] relative'>
                ...
                <div className='border md:border-none border-y-0 border-r-0 border-l-[#3734A9] border-l-8 ml-10 md:ml-0 mt-20 md:mt-0'>
                    ...
                    <div className='flex flex-col md:flex-row justify-between w-full gap-5'>
                        ...
                        <div className='flex items-center gap-5 w-full md:w-40 lg:w-[280px] ml-[0] md:ml-[90px] lg:ml-[100px] xl:ml-[135px]'>
                            ...
                            <div className='block md:hidden -ml-[19px] mt-4'>
                                <div className='w-[30px] h-[30px]  bg-[#3734A9] rounded-full flex items-center justify-center'>
                            ...
                            <div className='flex lg:p-5 relative -mt-[0] md:-mt-14'>
                                ...
                                <div className='absolute top-[20px] md:top-[-30px] right-0 lg:right-10 text-[#e0dfe9] font-semibold text-[60px] md:text-[80px] lg:text-[150px] leading-none font-serif -z-10'>1</div>
                            </div>
                        </div>
                        ...
                        <div className='flex gap-5 w-full md:w-40 lg:w-[280px] ml-[0] md:ml-[30px] lg:ml-[90px] xl:ml-[110px]'>
                            ...
                            <div className='flex lg:p-5 relative mt-[0] md:mt-[-115px] lg:mt-[-140px] xl:mt-[-190px]'>
                                ...
                                <div className='absolute top-[20px] md:top-[-30px] right-0 lg:right-10 text-[#e0dfe9] font-semibold text-[60px] md:text-[80px] lg:text-[150px] leading-none font-serif z-[-1]'>2</div>
                            </div>
                        </div>
                        ...
                        <div className='w-full md:w-40 lg:w-[280px] ml-[0] md:ml-[0px] lg:ml-[50px] xl:mr-[40px]'>
                            ...
                            <div className='relative flex gap-5 mb-5'>
                                ...
                                <div className='flex lg:p-5 relative mt-[0] md:mt-[-190px] lg:mt-[-240px] xl:mt-[-320px]'>
                                    ...
                                    <div className='absolute top-[20px] md:top-[-30px] right-0 lg:right-10 text-[#e0dfe9] font-semibold text-[60px] md:text-[80px] lg:text-[150px] leading-none font-serif z-[-1]'>3</div>
                                </div>
